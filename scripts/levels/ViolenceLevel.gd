...
const MARKS := {
	...
	"curtain_bent": [Vector3(3.60, 1.60, -1.50), 0.0, "Погнутый карниз",
...
func build_props() -> void:
	...
	mark_nodes["curtain_bent"] = root.placed_model(self, "CurtainBent",
		load("res://assets/models/curtain_rod.glb"), Vector3(3.60, 1.60, -1.86), Vector3(0, PI / 2, .10),
		{"metal": "brass"})
