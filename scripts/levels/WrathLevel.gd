...
const FLASHPOINTS := {
	"wrath_lamp": [Vector3(3.10, .20, -1.48), 1.35, "Опрокинутая лампа",
	...
	"wrath_pillow": [Vector3(2.15, .76, -2.00), -.20, "Подушка с прорехой",
		...
		Vector3(2.60, 1.25, -2.00)],
	"wrath_chair": [Vector3(2.35, .05, .65), 2.60, "Опрокинутый стул",
...
func build_props() -> void:
	...
	flash_nodes["wrath_lamp"] = root.placed_model(self, "WrathLamp",
		load("res://assets/models/table_lamp.glb"), Vector3(3.50, .24, -1.60), Vector3(0, .3, 1.4),
	...
	flash_nodes["wrath_pillow"] = root.placed_model(self, "WrathPillow",
		load("res://assets/models/bath_hand_towel.glb"), Vector3(2.15, .72, -2.00), Vector3(0, -.2, .3),
		{"fabric": "cream", "metal": "brass"})
	flash_nodes["wrath_chair"] = root.placed_model(self, "WrathChair",
		load("res://assets/models/desk_chair.glb"), Vector3(2.35, .05, .65), Vector3(1.4, 2.6, 0),
